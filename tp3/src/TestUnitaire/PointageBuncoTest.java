...
import Specifique.PointageBunco;

public class PointageBuncoTest {
	private PointageBunco points;
	...
	public void pointageBunco(){
		...
		assertTrue(points.calculerPointage(jeu) == 21);
	}
