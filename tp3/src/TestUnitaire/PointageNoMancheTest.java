...
import Specifique.PointageNoManche;

public class PointageNoMancheTest {
	private PointageNoManche points;
	...
	public void pointageBunco(){
		...
		assertTrue(points.calculerPointage(jeu) == 3);
	}
	...
	public void pointageNombre1(){
		...
		assertTrue(points.calculerPointage(jeu) == 1);
	}
	...
	public void pointageNombre2(){
		...
		de2.setFaceObtenue(1);
		de3.setFaceObtenue(3);
		assertTrue(points.calculerPointage(jeu) == 2);
	}
